...
class TestAfterInit:
    def test_when_default_seed(self):
        ...
        # This is by design: seed is common by default for all RandomForest objects
        # Otherwise, sklearn [check_parameters_default_constructible] test will fail:
        #   AssertionError: Parameter seed was mutated on init. All parameters must be stored unchanged.
